 ...
 */
const Team = ({ name, logo, exp, std, side, onOpen }) => {
    const jersey = useJersey(name);
        ...
        <div className="relative rounded-2xl border border-white/10 bg-zinc-900/60 backdrop-blur-md shadow-xl overflow-hidden">
            ...
            <div className="relative px-4 md:px-8 pt-7 pb-6 md:pt-9">
                ...
                <div className="relative grid grid-cols-[1fr_auto_1fr] items-center gap-3 md:gap-8">
                    <Team name={home} logo={teamLogos[home]} exp={prediction.expHome} std={prediction.expHomeStd} side="home" onOpen={onTeamClick} />
                    ...
                    <Team name={away} logo={teamLogos[away]} exp={prediction.expAway} std={prediction.expAwayStd} side="away" onOpen={onTeamClick} />
                </div>

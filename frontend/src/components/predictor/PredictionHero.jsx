                ...
                <div className="flex items-center justify-center gap-8 mb-8 w-full">
                    <div className="text-right flex-1 flex flex-col items-end">
                        ...
                        <div className="text-emerald-400 font-mono text-base font-bold mt-1">
                            Home Exp: {prediction.expHome.toFixed(2)}
                            <span className="text-xs text-zinc-500 ml-2 font-normal">σ {prediction.hForStd.toFixed(2)}</span>
                        </div>
                    </div>
                    ...
                    <div className="flex flex-col items-center">
                        ...
                        <div className="text-zinc-500 font-mono text-sm font-bold mt-[-10px]">
                    ...
                    <div className="text-left flex-1 flex flex-col items-start">
                        ...
                        <div className="text-blue-400 font-mono text-base font-bold mt-1">
                            Away Exp: {prediction.expAway.toFixed(2)}
                            <span className="text-xs text-zinc-500 ml-2 font-normal">σ {prediction.aForStd.toFixed(2)}</span>
                        </div>
                    </div>
                </div>
